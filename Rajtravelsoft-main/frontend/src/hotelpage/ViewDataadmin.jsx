    ...
    text-shadow: none !important;
            ...
            <div ref={componentRef} className="w-full max-w-7xl no-break print-area mx-auto ">
                ...
                <div className="flex bg-[#EEEADD] mb-0 flex-wrap gap-3 sm:gap-4 p-3 w-full">
                    ...
                    {/* Email Button */}
                    <button
                        className={`w-full sm:w-auto px-6 h-12 bg-gradient-to-r from-yellow-500 to-yellow-500 
      text-white rounded-full flex items-center justify-center gap-2
      text-sm font-semibold transition-all shadow-md
      ${emailLoading ? "cursor-not-allowed opacity-50" : "hover:from-yellow-600 hover:to-yellow-600 group"}`}
                    ...
                    {/* WhatsApp */}
                    <button
                        className="w-full mt-0 sm:w-auto px-6 h-12 bg-gradient-to-r from-yellow-600 to-yellow-600 
      text-white rounded-full flex items-center justify-center gap-2
      text-sm font-semibold transition-all shadow-md
      hover:from-yellow-700 hover:to-yellow-700 group"
                    ...
                    {booking?.contact && (
                        <div className="absolute inset-0 flex items-start top-[-4%] sm:top-0 justify-end py-4 w-full md:py-6 pointer-events-none">
                            <div className="rounded-lg  py-4 md:py-6 px-2 md:px-4 md:mt-6  w-full  pointer-events-auto">
                                ...
                                <div className=" flex justify-end   relative font-bold flex-col  mt-4  md:space-y-4 text-gray-800 text-xs md:text-sm lg:text-base">
...
">
            ...
            "
                            ...
                            {/* ====== DETAILED HOTEL LIST (Single Category) ====== */}
                            {/* ====== DETAILED HOTEL LIST (Single Category) ====== */}
                            <section className="border mb-8 overflow-hidden">
