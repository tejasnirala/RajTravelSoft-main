            ...
            <div ref={componentRef} className="">
                <div className="flex flex-col lg:flex-row relative min-h-[60vh] mx-auto">
                    <div className="w-full order-2 lg:order-1 lg:w-1/2 px-6 md:px-12">
                        ...
                        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4 mt-4">
                            <button
                                className={`px-4 py-2 cursor-pointer bg-green-500 text-white rounded-md flex items-center justify-center gap-2 text-sm font-medium transition-all ${emailLoading ? "cursor-not-allowed opacity-50" : ""}`}
                            ...
                            <button
                                className="px-4 py-2 bg-green-500 text-white rounded-md hover:bg-green-600 transition-all text-sm flex items-center justify-center gap-2 font-medium"
                ...
                <div className="bg-white p-8 rounded-3xl shadow-xl border border-yellow-200 mb-10">
                    ...
                    {bookingData?.itineraryData?.tourcode && (
                        <p className="text-gray-700 my-2 underline text-sm sm:text-lg">
